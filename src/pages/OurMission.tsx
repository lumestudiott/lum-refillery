        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-stone-600 leading-relaxed">
              To make fresh, sustainable groceries accessible to every household in Trinidad & Tobago, 
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            ...
            >
              ...
              <p className="text-stone-600 mb-4">
                Lumë Refillery was born from a simple observation: too many families struggle to access 
                fresh, quality groceries at fair prices, while local farmers struggle to find consistent 
                markets for their produce.
              </p>
              <p className="text-stone-600 mb-4">
                We created a subscription model that solves both problems. By connecting households 
                directly with local suppliers, we cut out middlemen, reduce waste, and ensure everyone 
                gets a fair deal.
              </p>
              <p className="text-stone-600">
                Our name "Lumë" means light in Albanian - representing our commitment to bringing 
                transparency and clarity to the food supply chain.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                description: 'We prioritize the wellbeing of our community, ensuring everyone has access to nutritious food.'
              },
              {
                icon: Users,
                title: 'Fair Partnerships',
                description: 'We pay fair prices to farmers and suppliers, building lasting relationships based on trust.'
              },
              {
                icon: Leaf,
                title: 'Sustainability',
                description: 'We minimize waste, use eco-friendly packaging, and support regenerative farming practices.'
              },
              {
                icon: Target,
                title: 'Transparency',
                description: 'We believe you should know where your food comes from and how it reaches your table.'
              }
            ].map((value, index) => (
              <motion.div
                key={value.title}
      ...
      <section className="py-16 bg-emerald-900">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-emerald-100 mb-8">
            Every subscription helps build a more sustainable food system for Trinidad & Tobago.
          </p>
          <Link
            to="/#pricing"
