...
const Sourcing: React.FC = () => {
  return (
    <section className="overflow-hidden bg-canvas">
      ...
      {/* ── Header ── */}
      <div className="mx-auto w-full max-w-[1440px] px-6 pt-24 pb-12 lg:px-12">
      ...
      <div className="relative px-6 pb-32 pt-8 lg:px-16 overflow-visible">
              ...
              >
                ...
                >
                  ...
                  <div className="relative h-[220px] w-full shrink-0 sm:h-[260px] lg:h-[320px] border-t-2 border-[#2B2B2B]/5">
                    ...
                    {/* Learn More Ribbon */}
                    <Link href={item.href} className="absolute bottom-6 right-0 bg-[#E8D5B7] pl-5 pr-4 py-2 shadow-lg transition-transform duration-500 group-hover:translate-x-0 group-hover:-translate-y-1 hover:bg-[#d8c29d]">
